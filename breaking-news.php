 ...
 <div style="margin-left:16%;  width: 90%;">
  ...
  <div style=" width: 70%; margin-left: 20%; margin-top: 5%">
    ...
    <table class="table table-bordered">
      ...
      $query=mysqli_query($conn,"select * from breaking-news limit $page1,3");
       while ($row=mysqli_fetch_array($query)) {
        ...
        <?php } ?>
             ...
             <ul class="pagination">
               ...
               <?php  
       $sql=mysqli_query($conn,"select * from breaking-news");
       ...
       $a= ceil($a);
        for ($b=1; $b <=$a ; $b++) { 
          ?>
           ...
           <li class="page-item">
                 <a class="page-link" href="breaking-news.php?page=<?php echo $b; ?>"> <?php echo $b; ?></a></li>
