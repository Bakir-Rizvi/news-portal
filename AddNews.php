 ...
 include('include/header.php');
  ...
  ?>
		   ...
		   <div style="margin-left:17%;  width: 80%;">
		        <ul class="breadcrumb">
		        	<li class="breadcrumb-item active"><a href="admin-panel.php">Home</a></li>
         ...
         <div style=" width: 70%; margin-left: 25%; ">
		  ...
		  <div class="form-group">
		    ...
		    <input type="text" placeholder="Title..." name="title" class="form-control" id="email" required >
		  </div>

		  <div class="form-group">
			  <label for="comment">Description:</label>
			 <textarea class="form-control" placeholder="Description..." rows="5" name="description" id="comment" required></textarea>
			</div>
