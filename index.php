            ...
            <div class="d-flex flex-column bg-light container-fluid" id="dabo">
              ...
              <div class="port-item1 p-2 border"> 
               ...
               <div class="port-item1 p-2 border">
                ...
                <div class="port-item1 p-2 border">
                <a href="contact-us.php"onclick="('Home');">CONTACT US</a>
                </div>
            </div>
            </div>
           <div class="col-sm-3 col-md-6 col-lg-5">
             <div class="container" id="dabo1">
                <div class="marquee">
                  <div class="breaking"><h1>BREAKINGNEWS::Sed ut persSed ut perspiciatis unde omnis iste natus</h1>
                    </div>  
